	...
	switch(state)
	{
		...
		case STATE_DECODE:
			...
			switch(opcode){
                ...
                case CTZ: //Count Zeros
                    selM3 = ry; // mux 3 recebe o valor do registrador y
                    OP = opcode; // case da função ULA recebe opcode ctz
                    selM2 = sULA; // mux 2 recebe saída da ULA
                    LoadReg[rx] = selM2; // valor é guardado no registrador x
